...
/// # Returns
///
/// `NSTDBool b` - True if `str` contains `pattern`.
...
/// # Returns
///
/// `NSTDBool b` - True if `str` starts with `pattern`.
...
/// # Returns
///
/// `NSTDBool b` - True if `str` ends with `pattern`.
...
/// # Returns
///
/// `NSTDUSize pos` - The position of `pattern` in str.
...
NSTDAPI NSTDErrorCode nstd_core_str_to_uppercase(NSTDStr *const str);
...
///
/// `NSTDErrorCode errc` - Nonzero on error.
NSTDAPI NSTDErrorCode nstd_core_str_to_lowercase(NSTDStr *const str);
...
/// # Returns
///
/// `NSTDFloat32 f` - The NSTDFloat32 parsed from the string.
...
/// # Returns
///
/// `NSTDFloat64 d` - The NSTDFloat64 parsed from the string.
...
/// # Returns
///
/// `NSTDInt8 sc` - The `NSTDInt8` parsed from the string.
...
/// # Returns
///
/// `NSTDUInt8 uc` - The `NSTDUInt8` parsed from the string.
...
/// # Returns
///
/// `NSTDInt16 s` - The `NSTDInt16` parsed from the string.
...
/// # Returns
///
/// `NSTDUInt16 us` - The `NSTDUInt16` parsed from the string.
...
/// # Returns
///
/// `NSTDInt32 i` - The `NSTDInt32` parsed from the string.
...
/// # Returns
///
/// `NSTDUInt32 ui` - The `NSTDUInt32` parsed from the string.
...
/// # Returns
///
/// `NSTDInt64 l` - The `NSTDInt64` parsed from the string.
...
/// # Returns
///
/// `NSTDUInt64 ul` - The `NSTDUInt64` parsed from the string.
...
/// # Returns
///
/// `NSTDISize l` - The `NSTDISize` parsed from the string.
...
/// # Returns
///
/// `NSTDUSize ul` - The `NSTDUSize` parsed from the string.
