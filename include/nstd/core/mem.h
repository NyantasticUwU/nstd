...
NSTDAPI void *nstd_core_mem_allocate(const NSTDCOREUSize size);
...
NSTDAPI void nstd_core_mem_fill(void *const ptr, const NSTDCOREUSize size, const NSTDCOREByte byte);
