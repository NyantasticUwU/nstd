...
NSTDAPI NSTDOSWindowsHandle nstd_os_windows_io_stdin();
...
NSTDAPI NSTDOSWindowsHandle nstd_os_windows_io_stdout();
...
NSTDAPI NSTDOSWindowsHandle nstd_os_windows_io_stderr();
