...
NSTDAPI NSTDGLState nstd_gl_state_new(NSTDWindow window, const NSTDGLStateDescriptor descriptor);
...
NSTDAPI NSTDGLDeviceInfo nstd_gl_device_handle_get_info(NSTDGLDeviceHandle device_handle);
...
NSTDAPI void nstd_gl_shader_module_free(NSTDGLShaderModule *shader);
...
NSTDAPI void nstd_gl_render_pipeline_free(NSTDGLRenderPipeline *pipeline);
...
NSTDAPI NSTDGLBuffer nstd_gl_buffer_new(const NSTDSlice *const bytes, NSTDGLDevice device);
