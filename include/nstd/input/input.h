...
NSTDAPI int nstd_input_is_key_down(const NSTDRawInput raw_input, const NSTDKey key);
...
NSTDAPI int nstd_input_is_key_up(const NSTDRawInput raw_input, const NSTDKey key);
...
NSTDAPI int nstd_input_is_mouse_down(const NSTDRawInput raw_input, const NSTDMouseButton button);
...
NSTDAPI int nstd_input_is_mouse_up(const NSTDRawInput raw_input, const NSTDMouseButton button);
