...
pub unsafe extern "C" fn nstd_sys_os_name() -> *mut c_char {
...
#[inline]
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_sys_free_os_name(os_name: *mut *mut c_char) {
...
#[inline]
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_sys_arch_name() -> *mut c_char {
...
#[inline]
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_sys_free_arch_name(arch_name: *mut *mut c_char) {
