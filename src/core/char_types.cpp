...
extern "C"
{
    ...
    NSTDAPI inline int nstd_core_char_types_is_control(const char chr)
    {
    ...
    NSTDAPI inline int nstd_core_char_types_is_blank(const char chr)
    {
    ...
    NSTDAPI inline int nstd_core_char_types_is_space(const char chr)
    {
    ...
    NSTDAPI inline int nstd_core_char_types_is_uppercase(const char chr)
    {
        return chr >= 'A' && chr <= 'Z';
    }
    ...
    NSTDAPI inline int nstd_core_char_types_is_lowercase(const char chr)
    {
        return chr >= 'a' && chr <= 'z';
    }
    ...
    NSTDAPI inline int nstd_core_char_types_is_alpha(const char chr)
    {
    ...
    NSTDAPI inline int nstd_core_char_types_is_digit(const char chr)
    {
        return chr >= '0' && chr <= '9';
    }
    ...
    NSTDAPI inline int nstd_core_char_types_is_hex_digit(const char chr)
    {
    ...
    NSTDAPI inline int nstd_core_char_types_is_alpha_numeric(const char chr)
    {
        return nstd_core_char_types_is_digit(chr)
    ...
    NSTDAPI inline int nstd_core_char_types_is_punctuation(const char chr)
    {
    ...
    NSTDAPI inline int nstd_core_char_types_is_graphical(const char chr)
    {
    ...
    NSTDAPI inline int nstd_core_char_types_is_printable(const char chr)
    {
    ...
    NSTDAPI inline char nstd_core_char_types_to_uppercase(const char chr)
    {
    ...
    NSTDAPI inline char nstd_core_char_types_to_lowercase(const char chr)
    {
