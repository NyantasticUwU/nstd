...
extern "C"
{
    ...
    NSTDAPI inline signed char nstd_core_int_types_schar_min()
    {
    ...
    NSTDAPI inline signed char nstd_core_int_types_schar_max()
    {
    ...
    NSTDAPI inline unsigned char nstd_core_int_types_uchar_max()
    {
    ...
    NSTDAPI inline short nstd_core_int_types_short_min()
    {
    ...
    NSTDAPI inline short nstd_core_int_types_short_max()
    {
    ...
    NSTDAPI inline unsigned short nstd_core_int_types_ushort_max()
    {
    ...
    NSTDAPI inline int nstd_core_int_types_int_min()
    {
    ...
    NSTDAPI inline int nstd_core_int_types_int_max()
    {
    ...
    NSTDAPI inline unsigned int nstd_core_int_types_uint_max()
    {
    ...
    NSTDAPI inline long nstd_core_int_types_long_min()
    {
    ...
    NSTDAPI inline long nstd_core_int_types_long_max()
    {
    ...
    NSTDAPI inline unsigned long nstd_core_int_types_ulong_max()
    {
    ...
    NSTDAPI inline long long nstd_core_int_types_longlong_min()
    {
    ...
    NSTDAPI inline long long nstd_core_int_types_longlong_max()
    {
    ...
    NSTDAPI inline unsigned long long nstd_core_int_types_ulonglong_max()
    {
