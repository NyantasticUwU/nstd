...
extern "C"
{
    ...
    signed char nstd_core_int_types_char_min()
    {
    ...
    signed char nstd_core_int_types_char_max()
    {
    ...
    unsigned char nstd_core_int_types_uchar_max()
    {
    ...
    short nstd_core_int_types_short_min()
    {
    ...
    short nstd_core_int_types_short_max()
    {
    ...
    unsigned short nstd_core_int_types_ushort_max()
    {
    ...
    int nstd_core_int_types_int_min()
    {
    ...
    int nstd_core_int_types_int_max()
    {
    ...
    unsigned int nstd_core_int_types_uint_max()
    {
    ...
    long nstd_core_int_types_long_min()
    {
    ...
    long nstd_core_int_types_long_max()
    {
    ...
    unsigned long nstd_core_int_types_ulong_max()
    {
    ...
    long long nstd_core_int_types_longlong_min()
    {
    ...
    long long nstd_core_int_types_longlong_max()
    {
    ...
    unsigned long long nstd_core_int_types_ulonglong_max()
    {
