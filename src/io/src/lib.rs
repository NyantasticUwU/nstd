...
pub unsafe extern "C" fn nstd_io_flush() -> c_int {
...
#[inline]
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_write_char(ch: c_char) -> c_int {
...
#[inline]
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_write(str: *const c_char) -> c_int {
...
/// Returns: `int errc` - Nonzero on error.
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_write_line(str: *const c_char) -> c_int {
...
#[inline]
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_flush_err() -> c_int {
...
#[inline]
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_write_char_err(ch: c_char) -> c_int {
...
#[inline]
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_write_err(str: *const c_char) -> c_int {
...
/// Returns: `int errc` - Nonzero on error.
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_write_line_err(str: *const c_char) -> c_int {
    let mut str = CStr::from_ptr(str).to_string_lossy().to_string();
    str.push('\n');
...
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_read_char(errc: *mut c_int) -> c_char {
    let mut byte = [0];
...
/// Returns: `char *in` - String read from stdin.
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_read_line(errc: *mut c_int) -> *mut c_char {
    let mut bytes = static_nstd_read(errc);
    bytes.push(b'\0');
    CString::from_vec_unchecked(bytes).into_raw()
}
...
#[inline]
#[cfg_attr(feature = "clib", no_mangle)]
pub unsafe extern "C" fn nstd_io_free_read(str: *mut *mut c_char) {
